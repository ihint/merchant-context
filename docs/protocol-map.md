...
| Paid machine requests | HTTP 402 systems such as [x402](https://github.com/x402-foundation/x402) | Payment requirements, payment payloads, payment schemes, transport-specific signaling, facilitator verification and settlement, and pay-per-request flows | Product fit, buyer consent, order recovery, or browser-native payment behavior |
...
- ACP uses date-based versions and lists `2026-04-17` as the latest stable OpenAPI, JSON Schema, examples, and changelog snapshot in the README.
  Source: https://github.com/agentic-commerce-protocol/agentic-commerce-protocol
  Checked: 2026-08-13.
- ACP says it was first implemented by both OpenAI and Stripe, with production-ready reference implementations for merchants and developers.
  Source: https://github.com/agentic-commerce-protocol/agentic-commerce-protocol
  Checked: 2026-08-13.
- ACP changelog contents include dated entries through `2026-04-17.md` plus an `unreleased` directory.
...
- UCP states that core capabilities include catalog search and lookup, cart building, identity linking, checkout, and order management.
  Source: https://ucp.dev/
  Checked: 2026-08-13.
- UCP says it is built on REST and JSON-RPC transports with built-in AP2, A2A, and MCP support.
  Source: https://ucp.dev/
  Checked: 2026-08-13.
- UCP says it is expanding beyond shopping into lodging and food, with detailed specifications coming soon.
  Source: https://ucp.dev/
  Checked: 2026-08-13.
- UCP says businesses remain the Merchant of Record and retain ownership of customer relationships.
  Source: https://ucp.dev/
  Checked: 2026-08-13.
...
- Cloudflare remote MCP docs describe building and deploying remote MCP servers on Cloudflare.
  ...
  Checked: 2026-08-13.
- Cloudflare remote MCP docs say remote MCP clients connect over Streamable HTTP and authorize client access using OAuth.
  Source: https://developers.cloudflare.com/agents/model-context-protocol/
  Checked: 2026-08-13.
...
- Cloudflare says its Web Bot Auth implementation does not support every component and parameter defined in RFC 9421.
  Source: https://developers.cloudflare.com/bots/reference/bot-verification/web-bot-auth/
  Checked: 2026-08-13.
- Cloudflare says transitive trust for agents is experimental and uses the RFC 7239 `Forwarded` header.
  Source: https://developers.cloudflare.com/bots/reference/bot-verification/web-bot-auth/
  Checked: 2026-08-13.
...
- x402 describes itself as an open standard for internet-native payments across crypto and fiat forms of value.
  ...
  Checked: 2026-08-13.
- x402 v2 defines core payment data independently from payment schemes and transport mechanisms.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-13.
- x402 v2 says transports include HTTP, MCP, A2A, and custom request-response systems.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-13.
- x402 v2 says HTTP payment-required signaling uses a base64-encoded `PAYMENT-REQUIRED` response header.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-13.
- x402 v2 says facilitator APIs are currently standardized as HTTP endpoints for `/verify`, `/settle`, and `/supported`.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-13.
- x402 specs include `x402-specification-v1.md`, `x402-specification-v2.md`, scheme specifications, and transport specifications.

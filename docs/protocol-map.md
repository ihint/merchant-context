...
| Google and Gemini commerce | [Universal Commerce Protocol](https://ucp.dev/) | Discovery, catalog search and lookup, cart building, identity linking, checkout, order management, native checkout, embedded checkout, AP2-backed payments, REST and JSON-RPC transports, A2A and MCP compatibility, and planned Lodging and Food specifications | Automatic support outside participating platforms, agents, and businesses |
...
| Cloudflare agent runtime | [Cloudflare Agents](https://developers.cloudflare.com/agents/) and [Cloudflare remote MCP](https://developers.cloudflare.com/agents/model-context-protocol/) | Hosted stateful agents, durable identity, local SQL storage, real-time connections, scheduled work, recoverable execution, browser, sandbox, AI Search, MCP tools, payments tools, and remote MCP with Streamable HTTP and OAuth | Merchant Context support, ACP support, UCP support, or a passing integration for this repo |
| Agent identity at the edge | [Cloudflare Web Bot Auth](https://developers.cloudflare.com/bots/reference/bot-verification/web-bot-auth/) | Signed HTTP messages for verified bots and agents using Cloudflare's Web Bot Auth implementation and a required well-known key directory | Permission to buy, spend, bypass policy, or identify the end user |
| Paid machine requests | HTTP 402 systems such as [x402](https://github.com/x402-foundation/x402) | Payment requirements, payment payloads, verification, settlement, pay-per-request flows, `exact`, `upto`, and `batch-settlement` schemes, and production facilitator choices | Product fit, buyer consent, order recovery, or browser-native payment behavior |
...
- ACP is beta and is maintained by OpenAI and Stripe according to the ACP README.
  ...
  Checked: 2026-08-25.
- ACP lists `2026-04-17` as the released OpenAPI, JSON Schema, examples, and changelog snapshot, with `unreleased/` reserved for current development.
  Source: https://github.com/agentic-commerce-protocol/agentic-commerce-protocol
  Checked: 2026-08-25.
...
- UCP says it provides building blocks for agentic commerce from discovery to checkout and beyond.
  Source: https://ucp.dev/
  Checked: 2026-08-25.
- UCP says core capabilities include catalog search and lookup, cart building, identity linking, checkout, and order management.
  Source: https://ucp.dev/
  Checked: 2026-08-25.
- UCP says it is built on REST and JSON-RPC transports with AP2, A2A, and MCP support built in.
  Source: https://ucp.dev/
  Checked: 2026-08-25.
- UCP says the latest published specification version is `2026-04-08`, with `draft`, `2026-04-08`, `2026-01-23`, and `2026-01-11` available in the version selector.
  Source: https://ucp.dev/latest/specification/overview/
  Checked: 2026-08-25.
- UCP specifies that a business profile at `/.well-known/ucp` describes capabilities for the protocol version it declares.
  Source: https://ucp.dev/latest/specification/overview/
  Checked: 2026-08-25.
- UCP roadmap says it does not commit to delivering specific features, and initiatives can change, be removed, or be added.
  Source: https://ucp.dev/documentation/roadmap/
  Checked: 2026-08-25.
- UCP roadmap says Lodging and Food specifications are being developed.
  Source: https://ucp.dev/documentation/roadmap/
  Checked: 2026-08-25.
...
- A2A says it is for agent-to-agent communication and is not a replacement for MCP.
  Source: https://a2a-protocol.org/latest/
  Checked: 2026-08-25.
- Cloudflare Agents docs describe hosted agents with durable identity, local SQL storage, real-time connections, scheduled work, and recoverable execution.
  Source: https://developers.cloudflare.com/agents/
  Checked: 2026-08-25.
- Cloudflare Agents docs list Browser, Sandbox, AI Search, MCP tools, payments, and other tools as agent capabilities.
  Source: https://developers.cloudflare.com/agents/
  Checked: 2026-08-25.
...
- Cloudflare Web Bot Auth requires a key directory at `/.well-known/http-message-signatures-directory`.
  Source: https://developers.cloudflare.com/bots/reference/bot-verification/web-bot-auth/
  Checked: 2026-08-25.
- Cloudflare Web Bot Auth requires the `Signature-Agent` header to point to the key directory.
  Source: https://developers.cloudflare.com/bots/reference/bot-verification/web-bot-auth/
  Checked: 2026-08-25.
...
- x402's typical flow uses `402 Payment Required`, `PAYMENT-REQUIRED`, `PAYMENT-SIGNATURE`, `/verify`, and `/settle`.
  Source: https://github.com/x402-foundation/x402
  Checked: 2026-08-25.
- x402 documentation says payment schemes include `exact`, `upto`, and `batch-settlement` under `specs/schemes/`.
  Source: https://github.com/x402-foundation/x402
  Checked: 2026-08-25.
- x402 v2 separates core data structures from transport mechanisms and payment schemes.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-25.
- x402 v2 lists HTTP, MCP, and A2A as example transport mechanisms.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-25.
- x402 documentation says production mainnet routes should choose a facilitator model explicitly.
  Source: https://github.com/x402-foundation/x402
  Checked: 2026-08-25.

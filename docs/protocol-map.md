...
| Google and Gemini commerce | [Universal Commerce Protocol](https://ucp.dev/) | Discovery, catalog search and lookup, cart building, identity linking, checkout, order management, native checkout, embedded checkout, post-purchase capability exchange, and announced shopping, lodging, and food industry coverage | Automatic support outside participating platforms, agents, and businesses |
...
| Paid machine requests | HTTP 402 systems such as [x402](https://github.com/x402-foundation/x402) | Payment requirements, payment payloads, facilitator verification and settlement, payment schemes, discovery APIs, and pay-per-request flows | Product fit, buyer consent, order recovery, or browser-native payment behavior |
...
- ACP uses date-based versions and lists `2026-04-17` as the latest stable OpenAPI, JSON Schema, examples, and changelog snapshot in the README.
  Source: https://github.com/agentic-commerce-protocol/agentic-commerce-protocol
  Checked: 2026-08-18.
- ACP's changelog directory contains dated releases through `2026-04-17` plus an `unreleased` development directory.
...
- UCP says it is built on REST and JSON-RPC transports with AP2, A2A, and MCP support built in.
  Source: https://ucp.dev/
  Checked: 2026-08-18.
- UCP currently shows a banner saying it is expanding to Lodging and Food, with detailed specifications coming soon.
  Source: https://ucp.dev/
  Checked: 2026-08-18.
...
- MCP specification `2025-06-18` defines the authoritative protocol requirements based on its schema.
  ...
  Checked: 2026-08-18.
- MCP uses JSON-RPC 2.0 messages and exposes resources, prompts, and tools to AI systems.
  Source: https://modelcontextprotocol.io/specification/2025-06-18
  Checked: 2026-08-18.
...
- A2A says it is for agent-to-agent communication and is not a replacement for MCP.
  Source: https://a2a-protocol.org/latest/
  Checked: 2026-08-18.
- Cloudflare Agents docs describe a Cloudflare-hosted durable agent runtime with Browser, Sandbox, AI Search, MCP, Payments, and other MCP tools.
...
- x402 describes itself as an open standard for internet-native payments across crypto and fiat forms of value.
  ...
  Checked: 2026-08-18.
- x402 v2 separates protocol data structures from transport representations such as HTTP, MCP, and A2A.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-18.
- x402 v2 standardizes facilitator `/verify` and `/settle` APIs as HTTP REST endpoints.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-18.
- x402 v2 includes discovery APIs for resources and search.
  Source: https://raw.githubusercontent.com/x402-foundation/x402/main/specs/x402-specification-v2.md
  Checked: 2026-08-18.
- x402's README typical HTTP flow uses `402 Payment Required`, `PAYMENT-REQUIRED`, `PAYMENT-SIGNATURE`, `/verify`, `/settle`, and `PAYMENT-RESPONSE`.
  Source: https://github.com/x402-foundation/x402
  Checked: 2026-08-18.
- MDN says HTTP `402 Payment Required` is nonstandard, reserved for future use, and has no standard use convention.
  ...
  Checked: 2026-08-18.
- MDN says browsers display HTTP `402 Payment Required` as a generic 4xx status code.
  Source: https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Status/402
  Checked: 2026-08-18.
- RFC 9110 registers HTTP `402 Payment Required` as reserved for future use.
